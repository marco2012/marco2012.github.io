    ...
    return (
        <div className="project-card max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-neutral-800 dark:border-slate-700">
            ...
            <div className="p-5 flex-grow">
                <div className="ml-2 text-sm text-gray-700 dark:text-slate-200 flex items-center">
            ...
            <div className="mb-4 ml-4">
                ...
                <div className="mb-4 ml-2 text-sm text-gray-700 dark:text-slate-200 flex items-center">
                    <CiCalendar className="mr-1" />{" "}
                    {new Date(project.date * 1000).toLocaleString("en-US", {
                        month: "long",
                        year: "numeric",
                    })}
                </div>
